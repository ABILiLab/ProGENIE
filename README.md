...
*Molecular stratification is central to precision prostate cancer management, yet high costs and tissue requirements limit routine clinical implementation. Here, we present ProGENIE, an interpretable artificial intelligence framework integrating pathology foundation models with multi-head attention pooling to infer genome-scale transcriptomic profiles (16,591 genes) directly from routine H&E-stained images. ProGENIE generates spatially resolved molecular heatmaps functioning as a transparent “virtual immunohistochemistry” layer, capturing coherent proliferation, stromal, and immune programs within the tumor microenvironment. In independent validation on a South Australian Hospitals (SAH) cohort, the model predicted 3,167 genes with Pearson correlation >0.4, substantially outperforming existing approaches. Additionally, model-derived pathway activities stratified recurrence-free survival comparably to ground-truth RNA sequencing, while inferred expression profiles were associated with predicted drug sensitivity and immunotherapy-relevant features. By enabling genome-scale molecular profiling from routine histology, ProGENIE provides a scalable, cost-effective strategy with the potential to expand access to precision oncology.*

### Overview
<p align="center">
  <img src="https://github.com/ABILiLab/ProGENIE/blob/main/pics/framwork.png" alt="model architecture" width="600"/>
</p>
